...
#    - https://github.com/mgee/dotfiles/blob/master/osx-setup
...
# Hostname
sudo scutil --set ComputerName ingeborg
sudo scutil --set HostName ingeborg
sudo scutil --set LocalHostName ingeborg
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Ingeborg"
...
###############################################################################
# SSD-specific tweaks and time machine                                        #
###############################################################################
...
defaults write NSGlobalDomain AppleLocale -string "da_DK"
